...
namespace MiniEngine.GraphicsManagement
{
    public static class Graphics2D
    {
        ...
        internal static void NewFrame()
        {
            ...
            Vector4 viewport = new Vector4(0, 0, Graphics.GetScreenWidth(), Graphics.GetScreenHeight());
            float L = viewport.X;
            ...
            for(int i = 0; i < itemCount; i++) 
            {
                ...
                if(lastShaderId == shaderId) 
                {
                    ...
                    GL.Uniform2f(uniforms[(int)Uniform.Resolution], viewport.Z, viewport.W);
                ...
                else 
                {
                    ...
                    GL.Uniform2f(GL.GetUniformLocation(lastShaderId, "uResolution"), viewport.Z, viewport.W);
        ...
        private static void AddVertices(DrawCommand command) 
        {
            ...
            if(!rect.IsZero()) 
            {
                rect.y = Graphics.GetScreenHeight() - rect.y - rect.height;
